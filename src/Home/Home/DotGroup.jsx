...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  ...
  return <div className="flex flex-col fixed top-[60%] right-7 gap-5">
    {/* home */}
    ...
    {/* recognition */}
    <AnchorLink className={`${selectedPage === 'recognition' ? selectedStyles : "bg-dark-grey"} w-3 h-3 rounded-full`} href="#recognition" onClick={() => setSelectedPage('recognition')} />
